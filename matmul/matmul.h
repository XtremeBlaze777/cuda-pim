#ifndef HALIDE_____matmul_h
#define HALIDE_____matmul_h
#include <stdint.h>
...
int matmul(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, int32_t _K, struct halide_buffer_t *_C_buffer);
