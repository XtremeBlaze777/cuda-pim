...
int gemvFull(struct halide_buffer_t *_rowA_buffer, struct halide_buffer_t *_vec_buffer, int32_t _width, struct halide_buffer_t *_output_buffer) {
 ...
 uint64_t _0 = (uint64_t)(_vec_buffer);
 uint64_t _1 = (uint64_t)(0ull);
 bool _2 = _0 != _1;
 if (!_2)
 {
  int32_t _3 = halide_error_buffer_argument_is_null(_ucon, "vec");
  return _3;
 }
 uint64_t _4 = (uint64_t)(_rowA_buffer);
 uint64_t _5 = (uint64_t)(0ull);
 bool _6 = _4 != _5;
 if (!_6)
 {
  int32_t _7 = halide_error_buffer_argument_is_null(_ucon, "rowA");
  return _7;
 }
 uint64_t _8 = (uint64_t)(_output_buffer);
 uint64_t _9 = (uint64_t)(0ull);
 bool _10 = _8 != _9;
 if (!_10)
 {
  int32_t _11 = halide_error_buffer_argument_is_null(_ucon, "output");
  return _11;
 }
 auto *_12 = _halide_buffer_get_host(_output_buffer);
 auto _output = _12;
 halide_maybe_unused(_output);
 uint32_t _13 = _halide_buffer_get_type(_output_buffer);
 bool _14 = _halide_buffer_get_device_dirty(_output_buffer);
 int32_t _15 = _halide_buffer_get_dimensions(_output_buffer);
 int32_t _16 = _halide_buffer_get_min(_output_buffer, 0);
 int32_t _17 = _halide_buffer_get_extent(_output_buffer, 0);
 int32_t _18 = _halide_buffer_get_stride(_output_buffer, 0);
 auto *_19 = _halide_buffer_get_host(_rowA_buffer);
 auto _rowA = _19;
 halide_maybe_unused(_rowA);
 uint32_t _20 = _halide_buffer_get_type(_rowA_buffer);
 bool _21 = _halide_buffer_get_device_dirty(_rowA_buffer);
 int32_t _22 = _halide_buffer_get_dimensions(_rowA_buffer);
 int32_t _23 = _halide_buffer_get_min(_rowA_buffer, 0);
 int32_t _24 = _halide_buffer_get_extent(_rowA_buffer, 0);
 int32_t _25 = _halide_buffer_get_stride(_rowA_buffer, 0);
 int32_t _26 = _halide_buffer_get_min(_rowA_buffer, 1);
 int32_t _27 = _halide_buffer_get_extent(_rowA_buffer, 1);
 int32_t _28 = _halide_buffer_get_stride(_rowA_buffer, 1);
 auto *_29 = _halide_buffer_get_host(_vec_buffer);
 auto _vec = _29;
 halide_maybe_unused(_vec);
 uint32_t _30 = _halide_buffer_get_type(_vec_buffer);
 bool _31 = _halide_buffer_get_device_dirty(_vec_buffer);
 int32_t _32 = _halide_buffer_get_dimensions(_vec_buffer);
 int32_t _33 = _halide_buffer_get_min(_vec_buffer, 0);
 int32_t _34 = _halide_buffer_get_extent(_vec_buffer, 0);
 int32_t _35 = _halide_buffer_get_stride(_vec_buffer, 0);
 bool _36 = _halide_buffer_is_bounds_query(_output_buffer);
 if (_36)
 {
  auto *_37 = _halide_buffer_get_shape(_output_buffer);
  auto *_38 = (void *)(nullptr);
  uint64_t _39 = (uint64_t)(0ull);
  auto *_40 = (struct halide_device_interface_t *)(nullptr);
  struct halide_dimension_t s0[1] = {
   {_16, _17, 1, 0},
  };
  auto *_41 = s0;
  auto *_42 = _halide_buffer_init(_output_buffer, _37, _38, _39, _40, 0, 32, 1, _41, _39);
  halide_maybe_unused(_42);
 } // if _36
 bool _43 = _halide_buffer_is_bounds_query(_rowA_buffer);
 if (_43)
 {
  auto *_44 = _halide_buffer_get_shape(_rowA_buffer);
  ...
  auto *_48 = s1;
  auto *_49 = _halide_buffer_init(_rowA_buffer, _44, _45, _46, _47, 0, 32, 2, _48, _46);
  halide_maybe_unused(_49);
 } // if _43
 bool _50 = _halide_buffer_is_bounds_query(_vec_buffer);
 if (_50)
 {
  auto *_51 = _halide_buffer_get_shape(_vec_buffer);
  auto *_52 = (void *)(nullptr);
  uint64_t _53 = (uint64_t)(0ull);
  auto *_54 = (struct halide_device_interface_t *)(nullptr);
  struct halide_dimension_t s2[1] = {
   {0, _width, 1, 0},
  };
  auto *_55 = s2;
  auto *_56 = _halide_buffer_init(_vec_buffer, _51, _52, _53, _54, 0, 32, 1, _55, _53);
  halide_maybe_unused(_56);
 } // if _50
 bool _57 = _halide_buffer_is_bounds_query(_vec_buffer);
 bool _58 = _halide_buffer_is_bounds_query(_output_buffer);
 bool _59 = _halide_buffer_is_bounds_query(_rowA_buffer);
 bool _60 = _58 || _59;
 bool _61 = _57 || _60;
 bool _62 = !(_61);
 if (_62)
 {
  uint32_t _63 = (uint32_t)(73728ull);
  bool _64 = _13 == _63;
  if (!_64)
  {
   uint32_t _65 = (uint32_t)(73728ull);
   int32_t _66 = halide_error_bad_type(_ucon, "Output buffer output", _13, _65);
   return _66;
  }
  bool _67 = _15 == 1;
  if (!_67)
  {
   int32_t _68 = halide_error_bad_dimensions(_ucon, "Output buffer output", _15, 1);
   return _68;
  }
  uint32_t _69 = (uint32_t)(73728ull);
  bool _70 = _20 == _69;
  if (!_70)
  {
   uint32_t _71 = (uint32_t)(73728ull);
   int32_t _72 = halide_error_bad_type(_ucon, "Input buffer rowA", _20, _71);
   return _72;
  }
  bool _73 = _22 == 2;
  if (!_73)
  {
   int32_t _74 = halide_error_bad_dimensions(_ucon, "Input buffer rowA", _22, 2);
   return _74;
  }
  uint32_t _75 = (uint32_t)(73728ull);
  bool _76 = _30 == _75;
  if (!_76)
  {
   uint32_t _77 = (uint32_t)(73728ull);
   int32_t _78 = halide_error_bad_type(_ucon, "Input buffer vec", _30, _77);
   return _78;
  }
  bool _79 = _32 == 1;
  if (!_79)
  {
   int32_t _80 = halide_error_bad_dimensions(_ucon, "Input buffer vec", _32, 1);
   return _80;
  }
  bool _81 = 0 <= _17;
  if (!_81)
  {
   int32_t _82 = halide_error_buffer_extents_negative(_ucon, "Output buffer output", 0, _17);
   return _82;
  }
  bool _83 = _23 <= 0;
  int32_t _84 = _24 + _23;
  ...
  if (!_86)
  {
   int32_t _87 = _width + -1;
   int32_t _88 = _24 + _23;
   int32_t _89 = _88 + -1;
   int32_t _90 = halide_error_access_out_of_bounds(_ucon, "Input buffer rowA", 0, 0, _87, _23, _89);
   return _90;
  }
  bool _91 = 0 <= _24;
  if (!_91)
  {
   int32_t _92 = halide_error_buffer_extents_negative(_ucon, "Input buffer rowA", 0, _24);
   return _92;
  }
  bool _93 = _26 <= _16;
  int32_t _94 = _17 + _16;
  ...
  if (!_97)
  {
   int32_t _98 = _17 + _16;
   int32_t _99 = _98 + -1;
   int32_t _100 = _27 + _26;
   int32_t _101 = _100 + -1;
   int32_t _102 = halide_error_access_out_of_bounds(_ucon, "Input buffer rowA", 1, _16, _99, _26, _101);
   return _102;
  }
  bool _103 = 0 <= _27;
  if (!_103)
  {
   int32_t _104 = halide_error_buffer_extents_negative(_ucon, "Input buffer rowA", 1, _27);
   return _104;
  }
  bool _105 = _33 <= 0;
  int32_t _106 = _34 + _33;
  bool _107 = _width <= _106;
  bool _108 = _105 && _107;
  if (!_108)
  {
   int32_t _109 = _width + -1;
   int32_t _110 = _34 + _33;
   int32_t _111 = _110 + -1;
   int32_t _112 = halide_error_access_out_of_bounds(_ucon, "Input buffer vec", 0, 0, _109, _33, _111);
   return _112;
  }
  bool _113 = 0 <= _34;
  if (!_113)
  {
   int32_t _114 = halide_error_buffer_extents_negative(_ucon, "Input buffer vec", 0, _34);
   return _114;
  }
  bool _115 = _18 == 1;
  if (!_115)
  {
   int32_t _116 = halide_error_constraint_violated(_ucon, "output.stride.0", _18, "1", 1);
   return _116;
  }
  bool _117 = _25 == 1;
  if (!_117)
  {
   int32_t _118 = halide_error_constraint_violated(_ucon, "rowA.stride.0", _25, "1", 1);
   return _118;
  }
  bool _119 = _35 == 1;
  if (!_119)
  {
   int32_t _120 = halide_error_constraint_violated(_ucon, "vec.stride.0", _35, "1", 1);
   return _120;
  }
  int64_t _121 = (int64_t)(_27);
  int64_t _122 = (int64_t)(_24);
  int64_t _123 = _121 * _122;
  int64_t _124 = (int64_t)(_17);
  int64_t _125 = (int64_t)(0ll);
  int64_t _126 = _125 - _124;
  bool _127 = _124 > _125;
  int64_t _128 = (int64_t)(_127 ? _124 : _126);
  uint64_t _129 = (uint64_t)(_128);
  uint64_t _130 = _129;
  uint64_t _131 = (uint64_t)(2147483647ull);
  bool _132 = _130 <= _131;
  if (!_132)
  {
   int64_t _133 = (int64_t)(_17);
   int64_t _134 = (int64_t)(0ll);
   int64_t _135 = _134 - _133;
   bool _136 = _133 > _134;
   int64_t _137 = (int64_t)(_136 ? _133 : _135);
   uint64_t _138 = (uint64_t)(_137);
   uint64_t _139 = _138;
   uint64_t _140 = (uint64_t)(2147483647ull);
   int32_t _141 = halide_error_buffer_allocation_too_large(_ucon, "output", _139, _140);
   return _141;
  }
  int64_t _142 = (int64_t)(_24);
  ...
  if (!_150)
  {
   ...
   int32_t _159 = halide_error_buffer_allocation_too_large(_ucon, "rowA", _157, _158);
   return _159;
  }
  int64_t _160 = (int64_t)(_27);
  int64_t _161 = (int64_t)(_28);
  ...
  if (!_170)
  {
   int64_t _171 = (int64_t)(_27);
   int64_t _172 = (int64_t)(_28);
   ...
   int32_t _181 = halide_error_buffer_allocation_too_large(_ucon, "rowA", _179, _180);
   return _181;
  }
  ...
  if (!_183)
  {
   ...
   int32_t _185 = halide_error_buffer_extents_too_large(_ucon, "rowA", _123, _184);
   return _185;
  }
  int64_t _186 = (int64_t)(_34);
  ...
  if (!_194)
  {
   ...
   int32_t _203 = halide_error_buffer_allocation_too_large(_ucon, "vec", _201, _202);
   return _203;
  }
  bool _204 = !(_14);
  if (!_204)
  {
   int32_t _205 = halide_error_device_dirty_with_no_device_support(_ucon, "Output buffer output");
   return _205;
  }
  bool _206 = !(_21);
  if (!_206)
  {
   int32_t _207 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer rowA");
   return _207;
  }
  bool _208 = !(_31);
  if (!_208)
  {
   int32_t _209 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer vec");
   return _209;
  }
  auto *_210 = (void *)(nullptr);
  bool _211 = _output != _210;
  if (!_211)
  {
   int32_t _212 = halide_error_host_is_null(_ucon, "Output buffer output");
   return _212;
  }
  auto *_213 = (void *)(nullptr);
  bool _214 = _rowA != _213;
  if (!_214)
  {
   int32_t _215 = halide_error_host_is_null(_ucon, "Input buffer rowA");
   return _215;
  }
  auto *_216 = (void *)(nullptr);
  bool _217 = _vec != _216;
  if (!_217)
  {
   int32_t _218 = halide_error_host_is_null(_ucon, "Input buffer vec");
   return _218;
  }
  // produce output
  int32_t _219 = _26 * _28;
  int32_t _220 = _219 + _23;
  for (int _output_s0_j_rebased = 0; _output_s0_j_rebased < 0 + _17; _output_s0_j_rebased++)
  {
   {
    int32_t _sum[1];
    // produce sum
    _sum[0] = 0;
    int32_t _221 = _16 + _output_s0_j_rebased;
    int32_t _222 = _221 * _28;
    int32_t _223 = _222 - _220;
    for (int _sum_s1_i__x = 0; _sum_s1_i__x < 0 + _width; _sum_s1_i__x++)
    {
     int32_t _224 = _sum[0];
     int32_t _225 = _sum_s1_i__x + _223;
     int32_t _226 = ((int32_t *)_rowA)[_225];
     int32_t _227 = _sum_s1_i__x - _33;
     int32_t _228 = ((int32_t *)_vec)[_227];
     int32_t _229 = _226 * _228;
     int32_t _230 = _224 + _229;
     _sum[0] = _230;
    } // for _sum_s1_i__x
    // consume sum
    int32_t _231 = _sum[0];
    ((int32_t *)_output)[_output_s0_j_rebased] = _231;
   } // alloc _sum
  } // for _output_s0_j_rebased
 } // if _62
 return 0;
}
...
const struct halide_filter_metadata_t *gemvFull_metadata() {
 int64_t const *const *buffer_estimates__rowA = nullptr;
 const halide_scalar_value_t *scalar_def__rowA = nullptr;
 const halide_scalar_value_t *scalar_min__rowA = nullptr;
 const halide_scalar_value_t *scalar_max__rowA = nullptr;
 const halide_scalar_value_t *scalar_estimate__rowA = nullptr;
 int64_t const *const *buffer_estimates__vec = nullptr;
 const halide_scalar_value_t *scalar_def__vec = nullptr;
 const halide_scalar_value_t *scalar_min__vec = nullptr;
 const halide_scalar_value_t *scalar_max__vec = nullptr;
 const halide_scalar_value_t *scalar_estimate__vec = nullptr;
 int64_t const *const *buffer_estimates__width = nullptr;
 const halide_scalar_value_t *scalar_def__width = nullptr;
 const halide_scalar_value_t *scalar_min__width = nullptr;
 const halide_scalar_value_t *scalar_max__width = nullptr;
 const halide_scalar_value_t *scalar_estimate__width = nullptr;
 ...
 static const halide_filter_argument_t args[4] = {
  {
   ...
   scalar_min__rowA,
   scalar_max__rowA,
   scalar_estimate__rowA,
   buffer_estimates__rowA,
   },
  {
   "vec",
   halide_argument_kind_input_buffer,
   ...
   scalar_min__vec,
   scalar_max__vec,
   scalar_estimate__vec,
   buffer_estimates__vec,
   },
  {
   "width",
   ...
   scalar_min__width,
   scalar_max__width,
   scalar_estimate__width,
   buffer_estimates__width,
   },
  {
   "output",
