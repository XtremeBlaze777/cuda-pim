...
int gemv(struct halide_buffer_t *_rowA_buffer, struct halide_buffer_t *_vec_buffer, int32_t _width, struct halide_buffer_t *_output_buffer) {
 ...
 auto *_16 = _halide_buffer_get_host(_rowA_buffer);
 auto _rowA = _16;
 halide_maybe_unused(_rowA);
 uint32_t _17 = _halide_buffer_get_type(_rowA_buffer);
 bool _18 = _halide_buffer_get_device_dirty(_rowA_buffer);
 int32_t _19 = _halide_buffer_get_dimensions(_rowA_buffer);
 int32_t _20 = _halide_buffer_get_min(_rowA_buffer, 0);
 int32_t _21 = _halide_buffer_get_extent(_rowA_buffer, 0);
 int32_t _22 = _halide_buffer_get_stride(_rowA_buffer, 0);
 auto *_23 = _halide_buffer_get_host(_vec_buffer);
 auto _vec = _23;
 halide_maybe_unused(_vec);
 uint32_t _24 = _halide_buffer_get_type(_vec_buffer);
 bool _25 = _halide_buffer_get_device_dirty(_vec_buffer);
 int32_t _26 = _halide_buffer_get_dimensions(_vec_buffer);
 int32_t _27 = _halide_buffer_get_min(_vec_buffer, 0);
 int32_t _28 = _halide_buffer_get_extent(_vec_buffer, 0);
 int32_t _29 = _halide_buffer_get_stride(_vec_buffer, 0);
 bool _30 = _halide_buffer_is_bounds_query(_output_buffer);
 if (_30)
 {
  auto *_31 = _halide_buffer_get_shape(_output_buffer);
  auto *_32 = (void *)(nullptr);
  uint64_t _33 = (uint64_t)(0ull);
  auto *_34 = (struct halide_device_interface_t *)(nullptr);
  auto *_35 = (struct halide_dimension_t *)(nullptr);
  auto *_36 = _halide_buffer_init(_output_buffer, _31, _32, _33, _34, 0, 32, 0, _35, _33);
  halide_maybe_unused(_36);
 } // if _30
 bool _37 = _halide_buffer_is_bounds_query(_rowA_buffer);
 if (_37)
 {
  auto *_38 = _halide_buffer_get_shape(_rowA_buffer);
  auto *_39 = (void *)(nullptr);
  uint64_t _40 = (uint64_t)(0ull);
  auto *_41 = (struct halide_device_interface_t *)(nullptr);
  struct halide_dimension_t s0[1] = {
   {0, _width, 1, 0},
  };
  auto *_42 = s0;
  auto *_43 = _halide_buffer_init(_rowA_buffer, _38, _39, _40, _41, 0, 32, 1, _42, _40);
  halide_maybe_unused(_43);
 } // if _37
 bool _44 = _halide_buffer_is_bounds_query(_vec_buffer);
 if (_44)
 {
  auto *_45 = _halide_buffer_get_shape(_vec_buffer);
  auto *_46 = (void *)(nullptr);
  uint64_t _47 = (uint64_t)(0ull);
  auto *_48 = (struct halide_device_interface_t *)(nullptr);
  struct halide_dimension_t s1[1] = {
   {0, _width, 1, 0},
  };
  auto *_49 = s1;
  auto *_50 = _halide_buffer_init(_vec_buffer, _45, _46, _47, _48, 0, 32, 1, _49, _47);
  halide_maybe_unused(_50);
 } // if _44
 bool _51 = _halide_buffer_is_bounds_query(_vec_buffer);
 bool _52 = _halide_buffer_is_bounds_query(_output_buffer);
 bool _53 = _halide_buffer_is_bounds_query(_rowA_buffer);
 bool _54 = _52 || _53;
 bool _55 = _51 || _54;
 bool _56 = !(_55);
 if (_56)
 {
  uint32_t _57 = (uint32_t)(73728ull);
  bool _58 = _13 == _57;
  if (!_58)
  {
   uint32_t _59 = (uint32_t)(73728ull);
   int32_t _60 = halide_error_bad_type(_ucon, "Output buffer output", _13, _59);
   return _60;
  }
  bool _61 = _15 == 0;
  if (!_61)
  {
   int32_t _62 = halide_error_bad_dimensions(_ucon, "Output buffer output", _15, 0);
   return _62;
  }
  ...
  if (!_64)
  {
   ...
   int32_t _66 = halide_error_bad_type(_ucon, "Input buffer rowA", _17, _65);
   return _66;
  }
  bool _67 = _19 == 1;
  if (!_67)
  {
   int32_t _68 = halide_error_bad_dimensions(_ucon, "Input buffer rowA", _19, 1);
   return _68;
  }
  ...
  if (!_70)
  {
   ...
   int32_t _72 = halide_error_bad_type(_ucon, "Input buffer vec", _24, _71);
   return _72;
  }
  bool _73 = _26 == 1;
  if (!_73)
  {
   int32_t _74 = halide_error_bad_dimensions(_ucon, "Input buffer vec", _26, 1);
   return _74;
  }
  bool _75 = _20 <= 0;
  int32_t _76 = _21 + _20;
  ...
  if (!_78)
  {
   int32_t _79 = _width + -1;
   int32_t _80 = _21 + _20;
   int32_t _81 = _80 + -1;
   int32_t _82 = halide_error_access_out_of_bounds(_ucon, "Input buffer rowA", 0, 0, _79, _20, _81);
   return _82;
  }
  bool _83 = 0 <= _21;
  if (!_83)
  {
   int32_t _84 = halide_error_buffer_extents_negative(_ucon, "Input buffer rowA", 0, _21);
   return _84;
  }
  bool _85 = _27 <= 0;
  int32_t _86 = _28 + _27;
  ...
  if (!_88)
  {
   int32_t _89 = _width + -1;
   int32_t _90 = _28 + _27;
   int32_t _91 = _90 + -1;
   int32_t _92 = halide_error_access_out_of_bounds(_ucon, "Input buffer vec", 0, 0, _89, _27, _91);
   return _92;
  }
  bool _93 = 0 <= _28;
  if (!_93)
  {
   int32_t _94 = halide_error_buffer_extents_negative(_ucon, "Input buffer vec", 0, _28);
   return _94;
  }
  bool _95 = _22 == 1;
  if (!_95)
  {
   int32_t _96 = halide_error_constraint_violated(_ucon, "rowA.stride.0", _22, "1", 1);
   return _96;
  }
  bool _97 = _29 == 1;
  if (!_97)
  {
   int32_t _98 = halide_error_constraint_violated(_ucon, "vec.stride.0", _29, "1", 1);
   return _98;
  }
  int64_t _99 = (int64_t)(_21);
  int64_t _100 = (int64_t)(0ll);
  int64_t _101 = _100 - _99;
  bool _102 = _99 > _100;
  int64_t _103 = (int64_t)(_102 ? _99 : _101);
  uint64_t _104 = (uint64_t)(_103);
  uint64_t _105 = _104;
  uint64_t _106 = (uint64_t)(2147483647ull);
  bool _107 = _105 <= _106;
  if (!_107)
  {
   int64_t _108 = (int64_t)(_21);
   int64_t _109 = (int64_t)(0ll);
   int64_t _110 = _109 - _108;
   bool _111 = _108 > _109;
   int64_t _112 = (int64_t)(_111 ? _108 : _110);
   uint64_t _113 = (uint64_t)(_112);
   uint64_t _114 = _113;
   uint64_t _115 = (uint64_t)(2147483647ull);
   int32_t _116 = halide_error_buffer_allocation_too_large(_ucon, "rowA", _114, _115);
   return _116;
  }
  int64_t _117 = (int64_t)(_28);
  int64_t _118 = (int64_t)(0ll);
  int64_t _119 = _118 - _117;
  bool _120 = _117 > _118;
  int64_t _121 = (int64_t)(_120 ? _117 : _119);
  uint64_t _122 = (uint64_t)(_121);
  uint64_t _123 = _122;
  uint64_t _124 = (uint64_t)(2147483647ull);
  bool _125 = _123 <= _124;
  if (!_125)
  {
   int64_t _126 = (int64_t)(_28);
   int64_t _127 = (int64_t)(0ll);
   int64_t _128 = _127 - _126;
   bool _129 = _126 > _127;
   int64_t _130 = (int64_t)(_129 ? _126 : _128);
   uint64_t _131 = (uint64_t)(_130);
   uint64_t _132 = _131;
   uint64_t _133 = (uint64_t)(2147483647ull);
   int32_t _134 = halide_error_buffer_allocation_too_large(_ucon, "vec", _132, _133);
   return _134;
  }
  bool _135 = !(_14);
  if (!_135)
  {
   int32_t _136 = halide_error_device_dirty_with_no_device_support(_ucon, "Output buffer output");
   return _136;
  }
  bool _137 = !(_18);
  if (!_137)
  {
   int32_t _138 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer rowA");
   return _138;
  }
  bool _139 = !(_25);
  if (!_139)
  {
   int32_t _140 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer vec");
   return _140;
  }
  auto *_141 = (void *)(nullptr);
  bool _142 = _output != _141;
  if (!_142)
  {
   int32_t _143 = halide_error_host_is_null(_ucon, "Output buffer output");
   return _143;
  }
  auto *_144 = (void *)(nullptr);
  bool _145 = _rowA != _144;
  if (!_145)
  {
   int32_t _146 = halide_error_host_is_null(_ucon, "Input buffer rowA");
   return _146;
  }
  auto *_147 = (void *)(nullptr);
  bool _148 = _vec != _147;
  if (!_148)
  {
   int32_t _149 = halide_error_host_is_null(_ucon, "Input buffer vec");
   return _149;
  }
  {
   int32_t _sum[1];
   ...
   // produce sum
   _sum[0] = 0;
   for (int _sum_s1_j__x = 0; _sum_s1_j__x < 0 + _width; _sum_s1_j__x++)
   {
    int32_t _150 = _sum[0];
    int32_t _151 = _sum_s1_j__x - _20;
    int32_t _152 = ((int32_t *)_rowA)[_151];
    int32_t _153 = _sum_s1_j__x - _27;
    int32_t _154 = ((int32_t *)_vec)[_153];
    int32_t _155 = _152 * _154;
    int32_t _156 = _150 + _155;
    _sum[0] = _156;
   } // for _sum_s1_j__x
   // consume sum
   int32_t _157 = _sum[0];
   ((int32_t *)_output)[0] = _157;
  } // alloc _sum
 } // if _56
 return 0;
}
