#ifndef HALIDE_____gemvFull_h
#define HALIDE_____gemvFull_h
#include <stdint.h>
...
int gemvFull(struct halide_buffer_t *_rowA_buffer, struct halide_buffer_t *_vec_buffer, int32_t _width, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int gemvFull_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *gemvFull_metadata();
