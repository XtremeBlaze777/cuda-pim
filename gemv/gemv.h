#ifndef HALIDE_____gemv_h
#define HALIDE_____gemv_h
#include <stdint.h>
...
int gemv(struct halide_buffer_t *_rowA_buffer, struct halide_buffer_t *_vec_buffer, int32_t _width, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int gemv_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *gemv_metadata();
