...
#define halide_cpp_use_native_vector(type, lanes) (false)
#endif
#if halide_cpp_use_native_vector(uint8_t, 1024)
using uint8x1024_t = NativeVector<uint8_t, 1024>;
using uint8x1024_t_ops = NativeVectorOps<uint8_t, 1024>;
#else
using uint8x1024_t = CppVector<uint8_t, 1024>;
using uint8x1024_t_ops = CppVectorOps<uint8_t, 1024>;
#endif
#if halide_cpp_use_native_vector(int32_t, 1024)
using int32x1024_t = NativeVector<int32_t, 1024>;
using int32x1024_t_ops = NativeVectorOps<int32_t, 1024>;
#else
using int32x1024_t = CppVector<int32_t, 1024>;
using int32x1024_t_ops = CppVectorOps<int32_t, 1024>;
#endif
#if halide_cpp_use_native_vector(uint32_t, 1024)
using uint32x1024_t = NativeVector<uint32_t, 1024>;
using uint32x1024_t_ops = NativeVectorOps<uint32_t, 1024>;
#else
using uint32x1024_t = CppVector<uint32_t, 1024>;
using uint32x1024_t_ops = CppVectorOps<uint32_t, 1024>;
#endif
...
int tensor_add(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_output_buffer) {
 ...
 uint64_t _4 = (uint64_t)(_B_buffer);
 uint64_t _5 = (uint64_t)(0ull);
 bool _6 = _4 != _5;
 if (!_6)
 {
  int32_t _7 = halide_error_buffer_argument_is_null(_ucon, "B");
  return _7;
 }
 uint64_t _8 = (uint64_t)(_A_buffer);
 uint64_t _9 = (uint64_t)(0ull);
 bool _10 = _8 != _9;
 if (!_10)
 {
  int32_t _11 = halide_error_buffer_argument_is_null(_ucon, "A");
  return _11;
 }
 auto *_12 = _halide_buffer_get_host(_A_buffer);
 auto _A = _12;
 halide_maybe_unused(_A);
 uint32_t _13 = _halide_buffer_get_type(_A_buffer);
 bool _14 = _halide_buffer_get_device_dirty(_A_buffer);
 int32_t _15 = _halide_buffer_get_dimensions(_A_buffer);
 int32_t _16 = _halide_buffer_get_min(_A_buffer, 0);
 int32_t _17 = _halide_buffer_get_extent(_A_buffer, 0);
 int32_t _18 = _halide_buffer_get_stride(_A_buffer, 0);
 int32_t _19 = _halide_buffer_get_min(_A_buffer, 1);
 int32_t _20 = _halide_buffer_get_extent(_A_buffer, 1);
 int32_t _21 = _halide_buffer_get_stride(_A_buffer, 1);
 auto *_22 = _halide_buffer_get_host(_B_buffer);
 auto _B = _22;
 halide_maybe_unused(_B);
 uint32_t _23 = _halide_buffer_get_type(_B_buffer);
 bool _24 = _halide_buffer_get_device_dirty(_B_buffer);
 int32_t _25 = _halide_buffer_get_dimensions(_B_buffer);
 int32_t _26 = _halide_buffer_get_min(_B_buffer, 0);
 int32_t _27 = _halide_buffer_get_extent(_B_buffer, 0);
 int32_t _28 = _halide_buffer_get_stride(_B_buffer, 0);
 int32_t _29 = _halide_buffer_get_min(_B_buffer, 1);
 int32_t _30 = _halide_buffer_get_extent(_B_buffer, 1);
 int32_t _31 = _halide_buffer_get_stride(_B_buffer, 1);
 auto *_32 = _halide_buffer_get_host(_output_buffer);
 auto _output = _32;
 halide_maybe_unused(_output);
 uint32_t _33 = _halide_buffer_get_type(_output_buffer);
 bool _34 = _halide_buffer_get_device_dirty(_output_buffer);
 int32_t _35 = _halide_buffer_get_dimensions(_output_buffer);
 int32_t _36 = _halide_buffer_get_min(_output_buffer, 0);
 int32_t _37 = _halide_buffer_get_extent(_output_buffer, 0);
 int32_t _38 = _halide_buffer_get_stride(_output_buffer, 0);
 int32_t _39 = _halide_buffer_get_min(_output_buffer, 1);
 int32_t _40 = _halide_buffer_get_extent(_output_buffer, 1);
 int32_t _41 = _halide_buffer_get_stride(_output_buffer, 1);
 bool _42 = _halide_buffer_is_bounds_query(_A_buffer);
 if (_42)
 {
  int32_t _43 = ::halide_cpp_max(_37, 1024);
  auto *_44 = _halide_buffer_get_shape(_A_buffer);
  auto *_45 = (void *)(nullptr);
  uint64_t _46 = (uint64_t)(0ull);
  auto *_47 = (struct halide_device_interface_t *)(nullptr);
  int32_t _48 = ::halide_cpp_min(_37, 1024);
  int32_t _49 = _48 + _36;
  int32_t _50 = _49 + -1024;
  struct halide_dimension_t s0[2] = {
   {_50, _43, 1, 0},
   {_39, _40, _43, 0},
  };
  auto *_51 = s0;
  auto *_52 = _halide_buffer_init(_A_buffer, _44, _45, _46, _47, 0, 32, 2, _51, _46);
  halide_maybe_unused(_52);
 } // if _42
 bool _53 = _halide_buffer_is_bounds_query(_B_buffer);
 if (_53)
 {
  int32_t _54 = ::halide_cpp_max(_37, 1024);
  auto *_55 = _halide_buffer_get_shape(_B_buffer);
  auto *_56 = (void *)(nullptr);
  uint64_t _57 = (uint64_t)(0ull);
  auto *_58 = (struct halide_device_interface_t *)(nullptr);
  int32_t _59 = ::halide_cpp_min(_37, 1024);
  int32_t _60 = _59 + _36;
  int32_t _61 = _60 + -1024;
  struct halide_dimension_t s1[2] = {
   {_61, _54, 1, 0},
   {_39, _40, _54, 0},
  };
  auto *_62 = s1;
  auto *_63 = _halide_buffer_init(_B_buffer, _55, _56, _57, _58, 0, 32, 2, _62, _57);
  halide_maybe_unused(_63);
 } // if _53
 bool _64 = _halide_buffer_is_bounds_query(_output_buffer);
 if (_64)
 {
  int32_t _65 = ::halide_cpp_max(_37, 1024);
  auto *_66 = _halide_buffer_get_shape(_output_buffer);
  auto *_67 = (void *)(nullptr);
  uint64_t _68 = (uint64_t)(0ull);
  auto *_69 = (struct halide_device_interface_t *)(nullptr);
  int32_t _70 = ::halide_cpp_min(_37, 1024);
  int32_t _71 = _70 + _36;
  int32_t _72 = _71 + -1024;
  struct halide_dimension_t s2[2] = {
   {_72, _65, 1, 0},
   {_39, _40, _65, 0},
  };
  auto *_73 = s2;
  auto *_74 = _halide_buffer_init(_output_buffer, _66, _67, _68, _69, 0, 32, 2, _73, _68);
  halide_maybe_unused(_74);
 } // if _64
 bool _75 = _halide_buffer_is_bounds_query(_output_buffer);
 bool _76 = _halide_buffer_is_bounds_query(_A_buffer);
 bool _77 = _halide_buffer_is_bounds_query(_B_buffer);
 bool _78 = _76 || _77;
 bool _79 = _75 || _78;
 bool _80 = !(_79);
 if (_80)
 {
  uint32_t _81 = (uint32_t)(73728ull);
  bool _82 = _13 == _81;
  if (!_82)
  {
   uint32_t _83 = (uint32_t)(73728ull);
   int32_t _84 = halide_error_bad_type(_ucon, "Input buffer A", _13, _83);
   return _84;
  }
  bool _85 = _15 == 2;
  if (!_85)
  {
   int32_t _86 = halide_error_bad_dimensions(_ucon, "Input buffer A", _15, 2);
   return _86;
  }
  uint32_t _87 = (uint32_t)(73728ull);
  bool _88 = _23 == _87;
  if (!_88)
  {
   uint32_t _89 = (uint32_t)(73728ull);
   int32_t _90 = halide_error_bad_type(_ucon, "Input buffer B", _23, _89);
   return _90;
  }
  bool _91 = _25 == 2;
  if (!_91)
  {
   int32_t _92 = halide_error_bad_dimensions(_ucon, "Input buffer B", _25, 2);
   return _92;
  }
  uint32_t _93 = (uint32_t)(73728ull);
  bool _94 = _33 == _93;
  if (!_94)
  {
   uint32_t _95 = (uint32_t)(73728ull);
   int32_t _96 = halide_error_bad_type(_ucon, "Output buffer output", _33, _95);
   return _96;
  }
  bool _97 = _35 == 2;
  if (!_97)
  {
   int32_t _98 = halide_error_bad_dimensions(_ucon, "Output buffer output", _35, 2);
   return _98;
  }
  int32_t _99 = _16 + 1024;
  int32_t _100 = ::halide_cpp_min(_37, 1024);
  int32_t _101 = _100 + _36;
  bool _102 = _99 <= _101;
  int32_t _103 = _37 + _36;
  int32_t _104 = _17 + _16;
  bool _105 = _103 <= _104;
  bool _106 = _102 && _105;
  if (!_106)
  {
   int32_t _107 = ::halide_cpp_min(_37, 1024);
   int32_t _108 = _107 + _36;
   int32_t _109 = _108 + -1024;
   int32_t _110 = _37 + _36;
   int32_t _111 = _110 + -1;
   int32_t _112 = _17 + _16;
   int32_t _113 = _112 + -1;
   int32_t _114 = halide_error_access_out_of_bounds(_ucon, "Input buffer A", 0, _109, _111, _16, _113);
   return _114;
  }
  bool _115 = 0 <= _17;
  if (!_115)
  {
   int32_t _116 = halide_error_buffer_extents_negative(_ucon, "Input buffer A", 0, _17);
   return _116;
  }
  bool _117 = _19 <= _39;
  int32_t _118 = _40 + _39;
  int32_t _119 = _20 + _19;
  bool _120 = _118 <= _119;
  bool _121 = _117 && _120;
  if (!_121)
  {
   int32_t _122 = _40 + _39;
   int32_t _123 = _122 + -1;
   int32_t _124 = _20 + _19;
   int32_t _125 = _124 + -1;
   int32_t _126 = halide_error_access_out_of_bounds(_ucon, "Input buffer A", 1, _39, _123, _19, _125);
   return _126;
  }
  bool _127 = 0 <= _20;
  if (!_127)
  {
   int32_t _128 = halide_error_buffer_extents_negative(_ucon, "Input buffer A", 1, _20);
   return _128;
  }
  int32_t _129 = _26 + 1024;
  int32_t _130 = ::halide_cpp_min(_37, 1024);
  int32_t _131 = _130 + _36;
  bool _132 = _129 <= _131;
  int32_t _133 = _37 + _36;
  int32_t _134 = _27 + _26;
  bool _135 = _133 <= _134;
  bool _136 = _132 && _135;
  if (!_136)
  {
   int32_t _137 = ::halide_cpp_min(_37, 1024);
   int32_t _138 = _137 + _36;
   int32_t _139 = _138 + -1024;
   int32_t _140 = _37 + _36;
   int32_t _141 = _140 + -1;
   int32_t _142 = _27 + _26;
   int32_t _143 = _142 + -1;
   int32_t _144 = halide_error_access_out_of_bounds(_ucon, "Input buffer B", 0, _139, _141, _26, _143);
   return _144;
  }
  bool _145 = 0 <= _27;
  if (!_145)
  {
   int32_t _146 = halide_error_buffer_extents_negative(_ucon, "Input buffer B", 0, _27);
   return _146;
  }
  bool _147 = _29 <= _39;
  int32_t _148 = _40 + _39;
  int32_t _149 = _30 + _29;
  bool _150 = _148 <= _149;
  bool _151 = _147 && _150;
  if (!_151)
  {
   int32_t _152 = _40 + _39;
   int32_t _153 = _152 + -1;
   int32_t _154 = _30 + _29;
   int32_t _155 = _154 + -1;
   int32_t _156 = halide_error_access_out_of_bounds(_ucon, "Input buffer B", 1, _39, _153, _29, _155);
   return _156;
  }
  bool _157 = 0 <= _30;
  if (!_157)
  {
   int32_t _158 = halide_error_buffer_extents_negative(_ucon, "Input buffer B", 1, _30);
   return _158;
  }
  bool _159 = 1024 <= _37;
  if (!_159)
  {
   int32_t _160 = _37 + _36;
   int32_t _161 = ::halide_cpp_min(_37, 1024);
   int32_t _162 = _161 + _36;
   int32_t _163 = _162 + -1024;
   int32_t _164 = _160 + -1;
   int32_t _165 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, _163, _164, _36, _164);
   return _165;
  }
  bool _166 = 0 <= _40;
  if (!_166)
  {
   int32_t _167 = halide_error_buffer_extents_negative(_ucon, "Output buffer output", 1, _40);
   return _167;
  }
  bool _168 = _18 == 1;
  if (!_168)
  {
   int32_t _169 = halide_error_constraint_violated(_ucon, "A.stride.0", _18, "1", 1);
   return _169;
  }
  bool _170 = _28 == 1;
  if (!_170)
  {
   int32_t _171 = halide_error_constraint_violated(_ucon, "B.stride.0", _28, "1", 1);
   return _171;
  }
  bool _172 = _38 == 1;
  if (!_172)
  {
   int32_t _173 = halide_error_constraint_violated(_ucon, "output.stride.0", _38, "1", 1);
   return _173;
  }
  int64_t _174 = (int64_t)(_20);
  int64_t _175 = (int64_t)(_17);
  int64_t _176 = _174 * _175;
  int64_t _177 = (int64_t)(_30);
  int64_t _178 = (int64_t)(_27);
  int64_t _179 = _177 * _178;
  int64_t _180 = (int64_t)(_40);
  int64_t _181 = (int64_t)(_37);
  int64_t _182 = _180 * _181;
  int64_t _183 = (int64_t)(0ll);
  int64_t _184 = _183 - _175;
  bool _185 = _175 > _183;
  int64_t _186 = (int64_t)(_185 ? _175 : _184);
  uint64_t _187 = (uint64_t)(_186);
  uint64_t _188 = _187;
  uint64_t _189 = (uint64_t)(2147483647ull);
  bool _190 = _188 <= _189;
  if (!_190)
  {
   int64_t _191 = (int64_t)(_17);
   int64_t _192 = (int64_t)(0ll);
   int64_t _193 = _192 - _191;
   bool _194 = _191 > _192;
   int64_t _195 = (int64_t)(_194 ? _191 : _193);
   uint64_t _196 = (uint64_t)(_195);
   uint64_t _197 = _196;
   uint64_t _198 = (uint64_t)(2147483647ull);
   int32_t _199 = halide_error_buffer_allocation_too_large(_ucon, "A", _197, _198);
   return _199;
  }
  int64_t _200 = (int64_t)(_20);
  int64_t _201 = (int64_t)(_21);
  int64_t _202 = _200 * _201;
  int64_t _203 = (int64_t)(0ll);
  int64_t _204 = _203 - _202;
  bool _205 = _202 > _203;
  int64_t _206 = (int64_t)(_205 ? _202 : _204);
  uint64_t _207 = (uint64_t)(_206);
  uint64_t _208 = _207;
  uint64_t _209 = (uint64_t)(2147483647ull);
  bool _210 = _208 <= _209;
  if (!_210)
  {
   int64_t _211 = (int64_t)(_20);
   int64_t _212 = (int64_t)(_21);
   int64_t _213 = _211 * _212;
   int64_t _214 = (int64_t)(0ll);
   int64_t _215 = _214 - _213;
   bool _216 = _213 > _214;
   int64_t _217 = (int64_t)(_216 ? _213 : _215);
   uint64_t _218 = (uint64_t)(_217);
   uint64_t _219 = _218;
   uint64_t _220 = (uint64_t)(2147483647ull);
   int32_t _221 = halide_error_buffer_allocation_too_large(_ucon, "A", _219, _220);
   return _221;
  }
  int64_t _222 = (int64_t)(2147483647ll);
  bool _223 = _176 <= _222;
  if (!_223)
  {
   int64_t _224 = (int64_t)(2147483647ll);
   int32_t _225 = halide_error_buffer_extents_too_large(_ucon, "A", _176, _224);
   return _225;
  }
  int64_t _226 = (int64_t)(_27);
  int64_t _227 = (int64_t)(0ll);
  int64_t _228 = _227 - _226;
  bool _229 = _226 > _227;
  int64_t _230 = (int64_t)(_229 ? _226 : _228);
  uint64_t _231 = (uint64_t)(_230);
  uint64_t _232 = _231;
  uint64_t _233 = (uint64_t)(2147483647ull);
  bool _234 = _232 <= _233;
  if (!_234)
  {
   int64_t _235 = (int64_t)(_27);
   int64_t _236 = (int64_t)(0ll);
   int64_t _237 = _236 - _235;
   bool _238 = _235 > _236;
   int64_t _239 = (int64_t)(_238 ? _235 : _237);
   uint64_t _240 = (uint64_t)(_239);
   uint64_t _241 = _240;
   uint64_t _242 = (uint64_t)(2147483647ull);
   int32_t _243 = halide_error_buffer_allocation_too_large(_ucon, "B", _241, _242);
   return _243;
  }
  ...
  if (!_254)
  {
   ...
   int32_t _265 = halide_error_buffer_allocation_too_large(_ucon, "B", _263, _264);
   return _265;
  }
  ...
  if (!_267)
  {
   ...
   int32_t _269 = halide_error_buffer_extents_too_large(_ucon, "B", _179, _268);
   return _269;
  }
  int64_t _270 = (int64_t)(_37);
  int64_t _271 = (int64_t)(0ll);
  int64_t _272 = _271 - _270;
  bool _273 = _270 > _271;
  int64_t _274 = (int64_t)(_273 ? _270 : _272);
  uint64_t _275 = (uint64_t)(_274);
  uint64_t _276 = _275;
  uint64_t _277 = (uint64_t)(2147483647ull);
  bool _278 = _276 <= _277;
  if (!_278)
  {
   int64_t _279 = (int64_t)(_37);
   int64_t _280 = (int64_t)(0ll);
   int64_t _281 = _280 - _279;
   bool _282 = _279 > _280;
   int64_t _283 = (int64_t)(_282 ? _279 : _281);
   uint64_t _284 = (uint64_t)(_283);
   uint64_t _285 = _284;
   uint64_t _286 = (uint64_t)(2147483647ull);
   int32_t _287 = halide_error_buffer_allocation_too_large(_ucon, "output", _285, _286);
   return _287;
  }
  int64_t _288 = (int64_t)(_40);
  int64_t _289 = (int64_t)(_41);
  int64_t _290 = _288 * _289;
  int64_t _291 = (int64_t)(0ll);
  int64_t _292 = _291 - _290;
  bool _293 = _290 > _291;
  int64_t _294 = (int64_t)(_293 ? _290 : _292);
  uint64_t _295 = (uint64_t)(_294);
  uint64_t _296 = _295;
  uint64_t _297 = (uint64_t)(2147483647ull);
  bool _298 = _296 <= _297;
  if (!_298)
  {
   int64_t _299 = (int64_t)(_40);
   int64_t _300 = (int64_t)(_41);
   int64_t _301 = _299 * _300;
   int64_t _302 = (int64_t)(0ll);
   int64_t _303 = _302 - _301;
   bool _304 = _301 > _302;
   int64_t _305 = (int64_t)(_304 ? _301 : _303);
   uint64_t _306 = (uint64_t)(_305);
   uint64_t _307 = _306;
   uint64_t _308 = (uint64_t)(2147483647ull);
   int32_t _309 = halide_error_buffer_allocation_too_large(_ucon, "output", _307, _308);
   return _309;
  }
  int64_t _310 = (int64_t)(2147483647ll);
  bool _311 = _182 <= _310;
  if (!_311)
  {
   int64_t _312 = (int64_t)(2147483647ll);
   int32_t _313 = halide_error_buffer_extents_too_large(_ucon, "output", _182, _312);
   return _313;
  }
  bool _314 = !(_14);
  if (!_314)
  {
   int32_t _315 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer A");
   return _315;
  }
  bool _316 = !(_24);
  if (!_316)
  {
   int32_t _317 = halide_error_device_dirty_with_no_device_support(_ucon, "Input buffer B");
   return _317;
  }
  bool _318 = !(_34);
  if (!_318)
  {
   int32_t _319 = halide_error_device_dirty_with_no_device_support(_ucon, "Output buffer output");
   return _319;
  }
  auto *_320 = (void *)(nullptr);
  bool _321 = _A != _320;
  if (!_321)
  {
   int32_t _322 = halide_error_host_is_null(_ucon, "Input buffer A");
   return _322;
  }
  auto *_323 = (void *)(nullptr);
  bool _324 = _B != _323;
  if (!_324)
  {
   int32_t _325 = halide_error_host_is_null(_ucon, "Input buffer B");
   return _325;
  }
  auto *_326 = (void *)(nullptr);
  bool _327 = _output != _326;
  if (!_327)
  {
   int32_t _328 = halide_error_host_is_null(_ucon, "Output buffer output");
   return _328;
  }
  // produce output
  int32_t _329 = _37 + 1023;
  int32_t _330 = _329 >> 10;
  int32_t _331 = _39 * _41;
  int32_t _332 = 0 - _331;
  int32_t _333 = _29 * _31;
  int32_t _334 = _36 - _333;
  int32_t _335 = _334 - _26;
  int32_t _336 = _19 * _21;
  int32_t _337 = _36 - _336;
  int32_t _338 = _337 - _16;
  for (int _output_s0_x_x = 0; _output_s0_x_x < 0 + _330; _output_s0_x_x++)
  {
   int32_t _339 = _output_s0_x_x * 1024;
   int32_t _340 = _37 + -1024;
   int32_t _341 = ::halide_cpp_min(_339, _340);
   int32_t _342 = _341 + _332;
   int32_t _343 = _341 + _335;
   int32_t _344 = _341 + _338;
   for (int _output_s0_y_rebased = 0; _output_s0_y_rebased < 0 + _40; _output_s0_y_rebased++)
   {
    int32_t _345 = _39 + _output_s0_y_rebased;
    int32_t _346 = _21 * _345;
    int32_t _347 = _346 + _344;
    int32x1024_t _348 = int32x1024_t_ops::load(_A, _347);
    int32_t _349 = _31 * _345;
    int32_t _350 = _349 + _343;
    int32x1024_t _351 = int32x1024_t_ops::load(_B, _350);
    int32x1024_t _352 = _348 + _351;
    int32_t _353 = _41 * _345;
    int32_t _354 = _353 + _342;
    int32x1024_t_ops::store(_352, _output, _354);
   } // for _output_s0_y_rebased
  } // for _output_s0_x_x
 } // if _80
 return 0;
}
...
const struct halide_filter_metadata_t *tensor_add_metadata() {
 int64_t const *const *buffer_estimates__A = nullptr;
 const halide_scalar_value_t *scalar_def__A = nullptr;
 const halide_scalar_value_t *scalar_min__A = nullptr;
 const halide_scalar_value_t *scalar_max__A = nullptr;
 const halide_scalar_value_t *scalar_estimate__A = nullptr;
 int64_t const *const *buffer_estimates__B = nullptr;
 const halide_scalar_value_t *scalar_def__B = nullptr;
 const halide_scalar_value_t *scalar_min__B = nullptr;
 const halide_scalar_value_t *scalar_max__B = nullptr;
 const halide_scalar_value_t *scalar_estimate__B = nullptr;
 ...
 static const halide_filter_metadata_t md = {
  ...
  3,
  args,
  "x86-64-linux-avx-avx2-avx512-avx512_cannonlake-avx512_skylake-f16c-fma-sse41",
  "tensor_add",
  };
 return &md;
}
