#ifndef HALIDE_____tensor_add_h
#define HALIDE_____tensor_add_h
#include <stdint.h>
...
int tensor_add(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int tensor_add_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *tensor_add_metadata();
